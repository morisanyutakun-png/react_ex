        ...
        if getattr(req, 'user_mode', False):
            ...
            if isinstance(prompt, str) and ('\\documentclass' not in prompt):
                ...
                latex_skeleton = (
                    ...
                    "% lightbg, accentorange は不使用（参考書スタイル）\n"
                    "\\pagestyle{fancy}\n"
                    "\\fancyhf{}\n"
                    ...
                    "% --- 問題・解答コマンド（参考書スタイル） ---\n"
                    "\\newcommand{\\problem}[1]{\\subsection*{\\textsf{\\textbf{問題 #1}}}}\n"
                    "\\newcommand{\\answer}[1]{\\noindent\\rule{\\linewidth}{0.4pt}\\subsection*{\\textsf{問題 #1 の解答}}}\n\n"
                    "\\begin{document}\n\n"
                    "% ========================================\n"
                    "% 問題セクション\n"
                    "% ========================================\n"
                    "\\section*{問題}\n\n"
                    "% 問題をここに生成（\\problem{N} コマンドを使用）\n"
                    "% 例:\n"
                    "% \\problem{1}\n"
                    "% 問題文...\n\n"
                    "{{problems_section}}\n\n"
                ...
                latex_instr = (
                    ...
                    "   unicode-math, CJKutf8, tcolorbox, mdframed 等の追加は禁止。\n"
                    ...
                    "I) 各問題は \\problem{N} コマンドで始める。problembox環境は使わない。\n"
                    "J) 各解答は \\answer{N} コマンドで始める。answerbox環境は使わない。\n"
                    "   tcolorbox, mdframed, fbox等のボックス環境は絶対使用禁止。\n"
