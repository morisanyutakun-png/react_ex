      ...
      <div className="flex items-center gap-1 mb-3">
        {steps.map((s, i) => (
          <div key={i} className="flex items-center gap-1 flex-1">
            <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold ${s.active ? 'text-white bg-[#2563eb]' : 'text-[#86868b] border border-[#e5e5ea]'}`}>{s.n}</div>
      ...
      <div className="space-y-1.5">
        {['数学 — 微分積分', '物理 — 力学', '化学 — 有機化学'].map((t, i) => (
          <div key={i} className={`flex items-center gap-2 px-2.5 py-2 rounded-lg border text-[10px] font-semibold
            ${i === 0 ? 'border-[#2563eb]/30 bg-[#fff5f7] text-[#1d1d1f]' : 'border-black/8 text-[#515154]'}`}>
  ...
  return (
    <ScreenFrame title="品質を高める" color="#3b82f6">
      <div className="flex gap-1 mb-3">
        {['設定', '実行', '評価'].map((t, i) => (
          <div key={i} className={`flex-1 text-center py-1.5 rounded-lg text-[9px] font-bold ${i === 0 ? 'bg-[#2563eb] text-white' : 'bg-[#f0f4ff] text-[#515154]'}`}>{t}</div>
        ))}
      </div>
      <div className="space-y-2 p-2.5 rounded-xl bg-[#f0f4ff] border border-black/8">
...
function DiagramSearchPage() {
  return (
    <ScreenFrame title="問題を検索" color="#60a5fa">
      <div className="flex items-center gap-2 px-2.5 py-2 rounded-xl bg-[#f0f4ff] border border-black/8 mb-2.5">
  ...
  return (
    <ScreenFrame title="データ管理" color="#3b82f6">
      ...
      <div className="rounded-lg border border-black/8 overflow-hidden">
        <div className="grid grid-cols-4 text-[7px] font-bold text-[#515154] bg-[#f0f4ff] px-2 py-1.5"><span>ID</span><span>科目</span><span>難易度</span><span>操作</span></div>
...
<div className="max-w-4xl mx-auto px-4 sm:px-5 py-6 sm:py-10 pb-8 sm:pb-12">
      ...
      <div className="text-center mb-12 relative">
        ...
        <Link href="/" className="inline-flex items-center gap-2 mt-5 px-5 py-2 rounded-full bg-white/80 backdrop-blur-lg border border-black/8 shadow-sm text-[13px] font-bold text-[#515154] hover:text-[#1d1d1f] hover:border-[#2563eb]/20 transition-all">
        ...
        <div className="flex-1 min-w-0 space-y-10">
          ...
          <section id="overview" className="scroll-mt-24">
            <div className="relative overflow-hidden rounded-[20px] bg-white border border-black/10 p-4 sm:p-7" style={{ boxShadow: 'var(--shadow-card)' }}>
              ...
              {/* 抽象フロー図 */}
              <div className="p-4 sm:p-5 rounded-[16px] bg-[#f0f4ff] border border-black/8">
