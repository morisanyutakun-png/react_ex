...
function IcoCreate() {
  return (
    <svg className="w-10 h-10" viewBox="0 0 40 40" fill="none">
      <rect x="6" y="3" width="22" height="30" rx="3" fill="white" stroke="#1d1d1f" strokeWidth="1.8"/>
      <rect x="6" y="3" width="22" height="30" rx="3" fill="url(#hD1)" opacity=".08"/>
      <line x1="11" y1="10" x2="23" y2="10" stroke="#1d1d1f" strokeWidth="1.2" opacity=".4" strokeLinecap="round"/>
      <line x1="11" y1="14" x2="20" y2="14" stroke="#1d1d1f" strokeWidth="1.2" opacity=".3" strokeLinecap="round"/>
      <line x1="11" y1="18" x2="22" y2="18" stroke="#1d1d1f" strokeWidth="1.2" opacity=".25" strokeLinecap="round"/>
      <rect x="10" y="22" width="14" height="7" rx="2" fill="#1d1d1f" opacity=".08"/>
      <text x="13" y="27.5" fontSize="6" fontWeight="bold" fill="#1d1d1f" fontFamily="serif" opacity=".7">∑ f(x)</text>
      ...
      <defs>
        <linearGradient id="hD1" x1="6" y1="3" x2="28" y2="33"><stop stopColor="#1d1d1f"/><stop offset="1" stopColor="#636366"/></linearGradient>
        <linearGradient id="hP1" x1="23" y1="1" x2="37" y2="15"><stop stopColor="#1d1d1f"/><stop offset="1" stopColor="#86868b"/></linearGradient>
      </defs>
    </svg>
  );
}
...
function IcoTune() {
  return (
    <svg className="w-10 h-10" viewBox="0 0 40 40" fill="none">
      <circle cx="18" cy="20" r="10" stroke="#636366" strokeWidth="1.5" opacity=".25"/>
      <circle cx="18" cy="20" r="6" stroke="#636366" strokeWidth="1.8" opacity=".5"/>
      <circle cx="18" cy="20" r="2.5" fill="url(#hDi1)"/>
      <line x1="18" y1="8" x2="18" y2="11" stroke="#636366" strokeWidth="1.2" opacity=".4" strokeLinecap="round"/>
      <line x1="18" y1="29" x2="18" y2="32" stroke="#636366" strokeWidth="1.2" opacity=".4" strokeLinecap="round"/>
      <line x1="6" y1="20" x2="9" y2="20" stroke="#636366" strokeWidth="1.2" opacity=".4" strokeLinecap="round"/>
      <line x1="27" y1="20" x2="30" y2="20" stroke="#636366" strokeWidth="1.2" opacity=".4" strokeLinecap="round"/>
...
function DiagramCreateWizard() {
  ...
  return (
    <ScreenFrame title="問題をつくる" color="#1d1d1f">
      <div className="flex items-center gap-1 mb-3">
        {steps.map((s, i) => (
          <div key={i} className="flex items-center gap-1 flex-1">
            <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold ${s.active ? 'text-white bg-[#1d1d1f]' : 'text-[#c7c7cc] border border-[#e5e5ea]'}`}>{s.n}</div>
            {i < steps.length - 1 && <div className="flex-1 h-[2px] rounded-full" style={{ background: i === 0 ? '#1d1d1f' : '#e5e5ea' }} />}
          </div>
        ))}
      </div>
      <div className="space-y-1.5">
        {['数学 — 微分積分', '物理 — 力学', '化学 — 有機化学'].map((t, i) => (
          <div key={i} className={`flex items-center gap-2 px-2.5 py-2 rounded-lg border text-[10px] font-semibold
            ${i === 0 ? 'border-[#1d1d1f]/30 bg-[#1d1d1f]/[0.04] text-[#1d1d1f]' : 'border-black/[0.04] text-[#86868b]'}`}>
            <div className={`w-3 h-3 rounded-full border-2 flex items-center justify-center ${i === 0 ? 'border-[#1d1d1f]' : 'border-[#d1d1d6]'}`}>
              {i === 0 && <div className="w-1.5 h-1.5 rounded-full bg-[#1d1d1f]" />}
            </div>
            {t}
          </div>
        ))}
...
function DiagramTunePage() {
  return (
    <ScreenFrame title="品質を高める" color="#48484a">
...
function FlowDiagram() {
  return (
    <svg viewBox="0 0 480 100" fill="none" className="w-full h-auto">
      {/* テンプレート */}
      <rect x="0" y="20" width="120" height="60" rx="16" fill="white" stroke="#1d1d1f" strokeWidth="1.5"/>
      <rect x="0" y="20" width="120" height="60" rx="16" fill="#1d1d1f" opacity=".04"/>
      <text x="60" y="48" textAnchor="middle" fontSize="11" fontWeight="800" fill="#1d1d1f">テンプレート</text>
      ...
      <text x="240" y="40" textAnchor="middle" fontSize="14" fontWeight="900" fill="#636366">AI</text>
      <text x="240" y="57" textAnchor="middle" fontSize="11" fontWeight="800" fill="#636366">REM が自動生成</text>
      ...
      <defs>
        <linearGradient id="fGr1" x1="175" y1="10" x2="305" y2="90"><stop stopColor="#636366"/><stop offset="1" stopColor="#48484a"/></linearGradient>
        <linearGradient id="fGr2" x1="175" y1="10" x2="305" y2="90"><stop stopColor="#636366"/><stop offset="1" stopColor="#1d1d1f"/></linearGradient>
...
const FAQ_DATA = [
  ...
  {
    category: '生成・PDF', color: '#48484a', icon: '◇',
    items: [
...
<div className="max-w-4xl mx-auto px-4 sm:px-5 py-6 sm:py-10 pb-28 sm:pb-12">
      ...
      <div className="text-center mb-12">
        ...
        <Link href="/" className="inline-flex items-center gap-2 mt-5 px-5 py-2 rounded-full bg-white/60 backdrop-blur-lg border border-black/[0.04] shadow-sm text-[13px] font-bold text-[#86868b] hover:text-[#1d1d1f] hover:border-[#1d1d1f]/20 transition-all">
      ...
      <div className="flex gap-6 sm:gap-8">
        ...
        <div className="flex-1 min-w-0 space-y-10">
          ...
          <FeatureSection id="create" icon={<IcoCreate />} title="問題をつくる" subtitle="5ステップのウィザードで AI が試験問題を自動生成" color="#1d1d1f" href="/user"
          ...
          <FeatureSection id="tune" icon={<IcoTune />} title="品質を高める" subtitle="バランス調整とフィードバックで品質を継続改善" color="#48484a" href="/dev"
