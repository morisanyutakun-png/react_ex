...
const PresetThumbnail = ({ id, active }) => {
  const base = active ? 'text-[#0af]' : 'text-[#6a6a7a]';
  const bg = active ? 'bg-[#0af]/[0.08]' : 'bg-white/[0.04]';
  const accent = active ? 'bg-red-200' : 'bg-[#3a3a4a]';
  const accentStrong = active ? 'bg-red-400' : 'bg-[#5a5a6a]';
  const borderC = active ? 'border-[#0af]/20' : 'border-white/[0.08]';
  ...
  const thumbnails = {
    exam: (
      <div className={`${bg} rounded-lg p-3 h-28 flex flex-col gap-1.5 border ${borderC}`}>
        <div className="flex items-center justify-between">
          ...
          <div className={`text-[8px] font-bold px-1.5 py-0.5 rounded ${active ? 'bg-[#0af]/[0.12] text-[#0af]' : 'bg-white/[0.06] text-[#6a6a7a]'}`}>100点</div>
        </div>
        <div className={`h-1 w-full rounded ${accent} opacity-40`} />
        <div className="flex-1 flex flex-col justify-between">
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <div className={`w-4 h-4 rounded-full ${accentStrong} flex items-center justify-center text-[#f0f0f5] text-[7px] font-bold`}>1</div>
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1.5">
              <div className={`w-4 h-4 rounded-full ${accentStrong} flex items-center justify-center text-[#f0f0f5] text-[7px] font-bold`}>2</div>
              <div className={`h-1.5 flex-1 rounded ${accent}`} />
            </div>
    ...
    flashcard: (
      <div className={`${bg} rounded-lg p-3 h-28 flex flex-col border ${borderC}`}>
        <div className="grid grid-cols-2 gap-0 flex-1 rounded overflow-hidden border" style={{ borderColor: active ? '#fca5a5' : '#3a3a4a' }}>
          <div className={`text-[7px] font-bold text-center py-1 ${active ? 'bg-[#0af]/[0.12] text-[#0af]' : 'bg-white/[0.06] text-[#6a6a7a]'} border-r ${borderC}`}>問題</div>
          <div className={`text-[7px] font-bold text-center py-1 ${active ? 'bg-[#0af]/[0.12] text-[#0af]' : 'bg-white/[0.06] text-[#6a6a7a]'}`}>解答</div>
          {[1, 2, 3].map(n => (
    ...
    mock_exam: (
      <div className={`${bg} rounded-lg p-3 h-28 flex flex-col gap-1 border ${borderC}`}>
        <div className="flex items-center justify-between">
          ...
          <div className={`text-[7px] px-1.5 py-0.5 rounded ${active ? 'bg-[#0af]/[0.12] text-[#0af]' : 'bg-white/[0.06] text-[#6a6a7a]'} font-bold`}>60分</div>
        </div>
        <div className={`p-1.5 rounded ${active ? 'bg-[#0af]/[0.12]/50' : 'bg-white/[0.06]/50'} text-[6px] ${base}`}>
          【注意事項】解答用紙に記入
        </div>
        ...
        <div className="flex-1 space-y-1.5">
          {['問題', '解法', 'ポイント'].map((label, i) => (
            <div key={label} className="space-y-0.5">
              <div className={`text-[6px] font-bold px-1 py-0.5 rounded ${active ? 'bg-[#0af]/[0.12] text-[#0af]' : 'bg-white/[0.06] text-[#6a6a7a]'} inline-block`}>
                {label}
              </div>
  ...
  return (
    <div ref={wizardTopRef} className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-14 pb-28 sm:pb-16">
      ...
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="text-[14px] sm:text-[15px] text-[#6a6a7a] leading-relaxed max-w-md mx-auto font-medium tracking-[-0.01em]">
        ...
        <div className="wizard-guide mb-5">
          <div className="flex items-center gap-3 px-5 py-4 relative z-10">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[13px] font-semibold text-[#f0f0f5] leading-snug">
              ...
              <p className="text-[11px] text-[#5a5a6a] mt-0.5">
          ...
          <div className="space-y-3">
            ...
            {templates.length === 0 && !showCreateTemplate ? (
              <div className="text-center py-12">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white/[0.04] mb-3">
                  <svg className="w-7 h-7 text-[#3a3a4a]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                  </svg>
                </div>
                <p className="text-sm font-bold text-[#f0f0f5]">出題パターンがまだありません</p>
                <p className="text-xs text-[#6a6a7a] mt-1">下の「＋ 新しく作る」ボタンから出題パターンを作成しましょう</p>
              </div>
            ) : !showCreateTemplate ? (
              <div className="space-y-2">
                {templates.map((t) => {
                  ...
                  const dotColor = diffColors[diffLevel] || '#3a3a4a';
                      ...
                      <div className="p-3.5 sm:p-4 flex items-center gap-3 relative z-10">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-[15px] font-bold text-[#f0f0f5] leading-tight">
                              {subj || t.name || t.id}
                            </span>
                            {isActive && (
                              <div className="flex items-center justify-center w-[18px] h-[18px] rounded-full bg-[#0af] flex-shrink-0 shadow-sm shadow-[#0af]/30">
                          ...
                          {/* 2行目: 分野 › テーマ（パンくず） */}
                          {breadcrumb && (
                            <p className="text-[12px] text-[#9898a8] mt-0.5 truncate leading-snug">
                              {fld && <span className="font-medium">{fld}</span>}
                              {fld && thm && <span className="text-[#3a3a4a] mx-1">›</span>}
                              {thm && <span className="text-[#6a6a7a]">{thm}</span>}
                            </p>
                          )}
                              ...
                              <div className="flex gap-[3px]">
                                {[1, 2, 3, 4, 5, 6].map((i) => (
                                  <div
                                    ...
                                    style={{
                                      backgroundColor: i <= diffLevel ? dotColor : '#2a2a3a',
                                    }}
                                  />
                                ))}
                              </div>
                        ...
                        <div className="flex flex-col items-center gap-1 flex-shrink-0">
                          <div
                            ...
                            className="w-7 h-7 rounded-lg flex items-center justify-center text-[#3a3a4a]
                          ...
                          {!isActive && (
                            <svg className="w-4 h-4 text-[#3a3a4a] transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            {showCreateTemplate ? (
              <div className="card-glossy">
                ...
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <div>
                    <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">出題パターンを新しく作る</h3>
                    <p className="text-[11px] text-[#6a6a7a]">教科と分野を選ぶだけで自動作成されます</p>
                  </div>
                </div>
                ...
                {newTplSubject === '__custom' && (
                  <div>
                    <label className="block text-[11px] font-bold text-[#9898a8] uppercase tracking-wider mb-2">教科名（入力）</label>
                    <input
                      value={newTplCustomSubject}
                      onChange={(e) => setNewTplCustomSubject(e.target.value)}
                      className="w-full pl-4 pr-4 py-3 rounded-2xl border border-white/[0.06] bg-[#16161e] text-sm text-[#f0f0f5] font-medium
                        transition-all duration-300 hover:border-white/[0.12] hover:bg-[#1a1a26] hover:shadow-md
                        focus:border-[#0af]/40 focus:ring-2 focus:ring-[#0af]/20 focus:shadow-md
                        outline-none placeholder:text-[#3a3a4a] shadow-sm"
                      placeholder="例: 地学"
                      autoFocus
                    />
                  </div>
                ...
                {effectiveNewSubject && (
                  <div>
                    <label className="block text-[11px] font-bold text-[#9898a8] uppercase tracking-wider mb-2">
                      分野
                      <span className="text-[10px] font-normal text-[#5a5a6a] ml-1 normal-case tracking-normal">（任意）</span>
                    </label>
                          ...
                          <button key={f} type="button"
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold rounded-full border transition-all duration-300 ${
                              newTplField === f
                                ...
                                : 'bg-[#16161e]/80 text-[#9898a8] border-white/[0.06] hover:border-[#0af]/30 hover:text-[#0af] hover:shadow-md'
                            }`}>
                            {f}
                          </button>
                        ))}
                ...
                {effectiveNewSubject && (
                  <div>
                    <label className="block text-[11px] font-bold text-[#9898a8] uppercase tracking-wider mb-2">
                      テーマ
                      <span className="text-[10px] font-normal text-[#5a5a6a] ml-1 normal-case tracking-normal">（任意・さらに細かい分類）</span>
                    </label>
                    <input
                      type="text"
                      value={newTplTheme}
                ...
                <div className="flex flex-col gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2.5 rounded-xl text-sm font-medium text-[#6a6a7a] hover:text-[#c0c0d0] hover:bg-white/[0.04] transition-all"
                  >
                    キャンセル
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2 pt-1 px-1">
                  ...
                  <p className="text-[10px] text-[#5a5a6a]">保存後、自動で選択されます。そのまま「次のステップへ」で進めます。</p>
                </div>
              </div>
              </div>
            ) : (
              ...
              <button
                ...
                className="w-full p-4 rounded-2xl text-[#6a6a7a] section-frosted
                           hover:text-[#0af]
              ...
              <div className="section-frosted">
                <div className="p-4 relative z-10">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-[15px] font-bold text-[#f0f0f5]">{subj || selectedTemplate.name}</span>
                        <span className="px-1.5 py-0.5 bg-[#0af]/[0.06] text-[#0af] rounded-full text-[9px] font-bold">選択中</span>
                      </div>
                      {breadcrumb && (
                        <p className="text-[12px] text-[#9898a8] mt-0.5 truncate">
                          {fld && <span className="font-medium">{fld}</span>}
                          {fld && thm && <span className="text-[#3a3a4a] mx-1">›</span>}
                          {thm && <span className="text-[#6a6a7a]">{thm}</span>}
                        </p>
                      ...
                      {diffLevel > 0 && (
                        <div className="flex items-center gap-1.5 mt-1">
                          <div className="flex gap-[3px]">
                            {[1,2,3,4,5,6].map((i) => (
                              <div key={i} className="w-[5px] h-[5px] rounded-full" style={{ backgroundColor: i <= diffLevel ? dotColor : '#2a2a3a' }} />
                            ))}
                          </div>
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">問題数・参照設定</h3>
                  <p className="text-[11px] text-[#6a6a7a]">何問つくるか、過去問を何件参考にするか</p>
                </div>
              </div>
            ...
            <details className="tip-card">
              ...
              <div className="px-4 pb-4 text-xs text-[#6a6a7a] leading-relaxed space-y-1.5 animate-expand">
                <p>登録されている過去問を参考にして、新しい問題を自動で作ります。</p>
                <div className="bg-white/[0.04] rounded-xl p-2 border border-white/[0.06] space-y-1">
                  <div className="flex gap-2"><span className="text-[#0af] font-bold">1.</span> <span>選んだ科目・分野をもとに関連する過去問を自動検索</span></div>
                  <div className="flex gap-2"><span className="text-[#0af] font-bold">2.</span> <span>似ている問題を自動で見つけ出し、難易度も考慮</span></div>
                  <div className="flex gap-2"><span className="text-[#0af] font-bold">3.</span> <span>見つかった過去問を参考に、AIが類似の問題を新しく生成</span></div>
                </div>
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">参考問題を選択</h3>
                  <p className="text-[11px] text-[#6a6a7a]">選択中のパターンに合致する過去問が表示されます</p>
                </div>
              ...
              {/* 選択済み問題の表示 */}
              {selectedBaseProblem ? (
                <div className="mb-3 relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02]
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[13px] text-[#f0f0f5] leading-relaxed line-clamp-3 ml-[30px]">
                        ...
                        <div className="flex gap-1.5 mt-2 ml-[30px] flex-wrap">
                          {selectedBaseProblem.subject && (
                            <span className="px-2 py-0.5 bg-[#0af]/[0.08] text-[#0af] rounded-full text-[9px] font-bold">{selectedBaseProblem.subject}</span>
                          )}
                      ...
                      <button
                        ...
                        className="flex items-center justify-center w-8 h-8 rounded-xl bg-white/[0.04] hover:bg-[#ff5252]/10
                                   text-[#5a5a6a] hover:text-[#ff5252] transition-all duration-200 flex-shrink-0 active:scale-90"
                        title="選択を解除"
                      >
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  {subject && (
                    <span className="px-2.5 py-1 bg-[#0af]/[0.08] text-[#0af] rounded-full text-[10px] font-bold">{subject}</span>
                  )}
                  {field && (
                ...
                {/* インライン絞り込み検索 */}
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.03] border border-white/[0.04]
                                focus-within:bg-[#1a1a26] focus-within:border-[#ffab00]/30 focus-within:shadow-sm transition-all duration-200">
                  <svg className="w-3.5 h-3.5 text-[#3a3a4a] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    placeholder="絞り込み..."
                    className="flex-1 bg-transparent text-xs text-[#f0f0f5] outline-none placeholder:text-[#3a3a4a]"
                  />
                  {baseFilterQuery && (
                    <button onClick={() => setBaseFilterQuery('')} className="text-[#5a5a6a] hover:text-[#ff5252] transition-colors">
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                      </svg>
                    </button>
              ...
              {matchedLoading ? (
                <div className="flex flex-col items-center justify-center py-8 gap-2">
                  ...
                  <p className="text-[11px] text-[#5a5a6a]">過去問を取得中...</p>
                </div>
              ) : filteredProblems.length > 0 ? (
                <div className="space-y-2 max-h-80 overflow-y-auto pr-1 custom-scrollbar">
                  <div className="text-[10px] font-bold text-[#5a5a6a] uppercase tracking-wider px-1 mb-1">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 mb-1">
                              <span className="text-[10px] text-[#5a5a6a] font-mono">#{item.id ?? idx + 1}</span>
                            </div>
                            <div className="text-[13px] text-[#f0f0f5] leading-relaxed line-clamp-2">
                              <LatexText>{(item.stem || item.text || '').slice(0, 150)}</LatexText>
                            </div>
                            <div className="flex gap-1.5 mt-1.5 flex-wrap">
                              {item.subject && (
                                <span className="px-2 py-0.5 bg-[#0af]/[0.08] text-[#0af] rounded-full text-[9px] font-bold">{item.subject}</span>
                              )}
                ...
                <div className="text-center py-6">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/[0.04] mb-2">
                    <svg className="w-5 h-5 text-[#3a3a4a]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                  </div>
                  <p className="text-xs text-[#5a5a6a]">「{baseFilterQuery}」に一致する問題はありません</p>
                </div>
              ) : (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-[#5a5a6a]">この科目・分野の過去問はまだ登録されていません</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">生成方法</h3>
                  <p className="text-[11px] text-[#6a6a7a]">自動生成 or 手動で指示文を使う</p>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                ...
                >
                  <div className="relative z-10 flex items-start gap-3">
                    <div className={`flex items-center justify-center w-10 h-10 rounded-xl flex-shrink-0 transition-all duration-300 ${
                      mode === 'auto' ? 'bg-[#1d1d1f] text-white shadow-md' : 'bg-white/[0.04] text-[#6a6a7a]'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-bold text-[#f0f0f5]">AI 自動生成</div>
                      <div className="text-[11px] text-[#6a6a7a] mt-0.5 leading-relaxed">
                        ワンクリックで PDF まで自動作成
                      </div>
                    </div>
                    {mode === 'auto' && (
                ...
                >
                  <div className="relative z-10 flex items-start gap-3">
                    <div className={`flex items-center justify-center w-10 h-10 rounded-xl flex-shrink-0 transition-all duration-300 ${
                      mode === 'manual' ? 'bg-[#1d1d1f] text-white shadow-md' : 'bg-white/[0.04] text-[#6a6a7a]'
                    }`}>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-bold text-[#f0f0f5]">手動</div>
                      <div className="text-[11px] text-[#6a6a7a] mt-0.5 leading-relaxed">
                        AIへの指示文を取得して自分で AI に送る
                      </div>
                    </div>
                    {mode === 'manual' && (
                      <div className="check-circle checked flex-shrink-0" style={{ '--tw-ring-color': '#9898a8' }}>
                        <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">カスタム要望</h3>
                  <p className="text-[11px] text-[#6a6a7a]">問題の内容・形式についての要望を自由に記入</p>
                </div>
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full px-4 py-3 text-[13px] leading-relaxed border border-white/[0.06] bg-[#16161e] rounded-2xl
                    focus:outline-none focus:border-[#00e676] focus:ring-2 focus:ring-[#00e676]/20
                    placeholder:text-[#3a3a4a] transition-all hover:border-white/[0.12] hover:shadow-md
                    resize-none"
                />
                  ...
                  <div className="flex items-center gap-1.5">
                    {customRequest.trim() && (
                      <button
                        ...
                        className="text-[10px] text-[#5a5a6a] hover:text-[#ff5252] transition-colors flex items-center gap-0.5"
                      >
        ...
        <div className="space-y-6 wizard-section-enter">
          ...
          {selectedTemplate && (
            <div className="mb-6 section-frosted">
              <div className="p-4 relative z-10">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/[0.04]">
                    <Icons.File className="w-4 h-4 text-[#0af]" />
                  </div>
                  <div className="flex-1">
                    <div className="text-[10px] font-bold text-[#5a5a6a] uppercase tracking-wider mb-0.5">選択中の出題パターン</div>
                    <div className="text-sm font-bold text-[#f0f0f5]">{selectedTemplate.name}</div>
                  </div>
                </div>
                <div className="flex flex-wrap gap-1.5 mt-3 ml-12">
                {subject && (
                  <span className="px-2 py-0.5 bg-[#0af]/[0.08] text-[#0af] rounded-full text-[10px] font-bold">
                    科目: {subject}
                  </span>
                )}
                {field && (
                ...
                {theme && (
                  <span className="px-2 py-0.5 bg-[#b388ff]/[0.08] text-[#b388ff] rounded-full text-[10px] font-bold">
                    テーマ: {theme}
                  </span>
                )}
                {difficulty && (
                ...
                {numQuestions && (
                  <span className="px-2 py-0.5 bg-[#40c4ff]/[0.08] text-[#40c4ff] rounded-full text-[10px] font-bold">
                    問題数: {numQuestions}
                  </span>
                )}
                </div>
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">PDF の見た目を選ぶ</h3>
                ...
                >
                  ...
                  <div className="px-4 py-3 relative z-10">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm font-bold text-[#f0f0f5]">{p.name}</div>
                    </div>
          ...
          {/* 選択中プレビュー */}
          {selectedPreset && (
            <div className="mt-4 px-4 py-3 bg-white/[0.02] rounded-2xl border border-white/[0.06] flex items-center gap-2.5">
              <div className="check-circle checked !w-5 !h-5">
                <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <span className="text-xs font-bold text-[#0af]">{selectedPreset.name}</span>
              <span className="text-[11px] text-[#6a6a7a]">{selectedPreset.description}</span>
            </div>
          )}
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
                <div className="flex items-center gap-2.5 mb-1">
                  ...
                  <div>
                    <div className="text-[13px] font-extrabold text-[#f0f0f5] tracking-tight">
                      問題形式を選択してください
                    </div>
                    <div className="text-[10px] text-[#0af] font-bold mt-0.5">
                  ...
                  return (
                    <button
                      ...
                      className={`relative overflow-hidden rounded-xl p-3.5 text-left transition-all duration-300 active:scale-[0.97]
                        ${active
                          ? 'bg-white/[0.04] border-2 border-[#1d1d1f]/30 shadow-sm'
                          : 'bg-white/[0.02] border-2 border-transparent hover:bg-white/[0.04] hover:border-white/[0.06]'
                        }`}
                    >
                      <div className="flex items-start gap-2.5">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5">
                            <span className={`text-[13px] font-bold transition-colors ${active ? 'text-[#b388ff]' : 'text-[#f0f0f5]'}`}>
                              {fmt.label}
                            </span>
                          </div>
                          <div className="text-[10px] text-[#6a6a7a] mt-0.5 leading-snug">{fmt.description}</div>
                        </div>
                        {/* チェックマーク */}
                        {active && (
          ...
          <div className="card-glossy">
            <div className="p-5 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">図表・イラスト</h3>
                  <p className="text-[11px] text-[#6a6a7a]">図・グラフ・コードが必要な場合に選択。不要なら選ばなくてOK</p>
                </div>
              ...
              {DIAGRAM_PACKAGE_DEFS.map((pkg) => {
                ...
                return (
                  <button
                    ...
                    className={`selection-card !p-0 text-left ${
                      active ? 'active !border-[#b388ff] !shadow-[0_0_0_3px_rgba(175,82,222,0.08)]' : ''
                    }`}
                  >
                    {/* ASCIIアートプレビュー */}
                    {illustration && (
                      <div className={`px-3 pt-2.5 pb-2 ${active ? 'bg-[#b388ff]/[0.06]' : 'bg-white/[0.03]'}`}>
                        <pre
                          className={`text-[9px] sm:text-[8px] leading-[1.35] font-mono select-none transition-colors ${active ? 'text-[#b388ff]' : 'text-[#3a3a4a]'}`}
                    ...
                    <div className="px-4 py-2.5 relative z-10">
                      <div className="flex items-center gap-2 flex-wrap">
                        {active ? (
                          <div className="check-circle checked !w-5 !h-5 !border-[#b388ff]" style={{ background: 'linear-gradient(135deg, #b388ff, #7c4dff)' }}>
                            <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                            </svg>
                          </div>
                        ...
                        <span className={`text-sm leading-none ${active ? 'text-[#b388ff]' : 'text-[#3a3a4a]'}`}>
                          {pkg.icon}
                        </span>
                        <span className="text-xs font-bold text-[#f0f0f5]">{pkg.name}</span>
                        <span className={`px-1.5 py-0.5 rounded-full text-[9px] font-bold ${
                          active ? 'bg-[#b388ff]/[0.1] text-[#b388ff]' : 'bg-white/[0.04] text-[#5a5a6a]'
                        }`}>
                          {pkg.label}
                        </span>
                        {pkg.recommended && (
                      ...
                      <p className="text-[10px] text-[#6a6a7a] mt-1 ml-7 leading-tight">{pkg.hint || pkg.description}</p>
                    </div>
                  </button>
                );
              })}
              ...
              <div className="mt-4 animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-bold text-[#f0f0f5]">大問ごとに図を自動挿入</div>
                      <div className="text-[11px] text-[#6a6a7a] mt-0.5 leading-relaxed">
            ...
            <div className="mt-3 flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 text-xs border border-white/[0.06] bg-[#16161e] rounded-2xl
                           focus:outline-none focus:border-[#b388ff] focus:ring-2 focus:ring-[#b388ff]/20
                           placeholder:text-[#3a3a4a] transition-all hover:border-white/[0.12] hover:shadow-md"
              />
              <button
                onClick={addCustomPackage}
                disabled={!customPackage.trim()}
                className="px-4 py-2.5 text-xs font-bold bg-[#16161e] border border-white/[0.06] text-[#f0f0f5] rounded-2xl
                           hover:bg-white/[0.04] hover:border-white/[0.12] disabled:opacity-30 transition-all"
              >
                追加
              </button>
            </div>
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {extraPackages.map((pkg) => {
                  ...
                  return (
                    <span
                      key={pkg}
                      className="inline-flex items-center gap-1 px-2 py-1 bg-[#b388ff]/[0.08] text-[#b388ff] rounded-full text-[10px] font-bold"
                    >
                      {def?.name || pkg}
                      <button
          ...
          <div className="card-glossy generating-glow">
            <div className="flex flex-col items-center justify-center py-24 px-8 relative z-10">
              ...
              <div className="relative mb-8">
                <div className="absolute inset-[-12px] rounded-full border-2 border-[#0af]/15 animate-ping" />
                <div className="absolute inset-[-24px] rounded-full border border-[#0af]/8 animate-pulse" />
                <div className="icon-glossy relative w-16 h-16"
                  style={{ background: 'linear-gradient(145deg, #40c4ff 0%, #0af 50%, #0088cc 100%)' }}>
              ...
              <p className="text-lg font-bold text-[#f0f0f5] mb-2 tracking-[-0.02em]">問題を生成しています</p>
              <p className="text-sm text-[#0af] font-medium">{status}</p>
              <p className="text-[13px] text-[#5a5a6a] mt-4">しばらくお待ちください...</p>
            </div>
          </div>
        </div>
      )}
            ...
            <div className={`rounded-2xl border text-xs px-5 py-4 shadow-sm ${
              renderContext.rag_status === 'ok' && renderContext.rag_retrieved > 0
                ...
                : renderContext.rag_status === 'no_data'
                  ? 'bg-[#40c4ff]/[0.08] border-blue-200'
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${
                  renderContext.rag_status === 'ok' && renderContext.rag_retrieved > 0
                    ? 'bg-emerald-900/50 text-[#00e676]'
                    : renderContext.rag_status === 'no_data'
                      ? 'bg-blue-900/50 text-blue-400'
                      : 'bg-white/[0.06] text-[#6a6a7a]'
                }`}>
                ...
                <div className="flex-1">
                  {renderContext.rag_status === 'ok' && renderContext.rag_retrieved > 0 ? (
                    ...
                    <div>
                      <span className="font-bold text-[#c0c0d0]">AIのみで問題を生成しました</span>
                      <p className="text-[#6a6a7a] mt-0.5">
                        この条件に合う過去問がデータ内に見つかりませんでした（{renderContext.chunk_count}件を検索）
                      </p>
                    </div>
                  ) : renderContext.rag_status === 'fallback' ? (
                    <div>
                      <span className="font-bold text-[#c0c0d0]">過去問が見つからず、AIのみで生成しました</span>
                      <p className="text-[#6a6a7a] mt-0.5">
                        この条件に合う過去問がデータ内に見つかりませんでした（{renderContext.chunk_count}件を検索）
                      </p>
                    </div>
                  ) : renderContext.chunk_count > 0 ? (
                    <span className="text-[#c0c0d0] font-bold">
                      {renderContext.chunk_count}件を参照して生成
                    </span>
                  ) : (
                    <span className="text-[#6a6a7a]">過去問未参照 — AIのみで生成</span>
                  )}
                </div>

                {/* 検索方式バッジ */}
                {renderContext.rag_method && (
                  <span className="px-1.5 py-0.5 rounded bg-[#16161e] text-[#6a6a7a] text-[9px] font-bold uppercase">
            ...
            <div className="card-glossy">
              <div className="p-5 relative z-10">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-[15px] font-bold text-[#f0f0f5] tracking-tight">生成結果</h3>
                    <p className="text-[11px] text-[#6a6a7a]">AIが生成した問題のプレビュー</p>
                  </div>
                </div>
              <div className="space-y-4">
                {pdfUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 p-4 bg-[#00e676]/[0.08] text-[#00e676] rounded-xl border border-[#00e676]/20 font-bold hover:bg-emerald-900/50 transition-colors"
                  >
                ...
                <details className="group">
                  <summary className="cursor-pointer text-[#6a6a7a] text-xs font-bold hover:text-[#0af] transition-colors list-none flex items-center gap-2">
                    <span className="w-4 h-4 rounded bg-white/[0.04] flex items-center justify-center group-open:rotate-90 transition-transform text-[10px]">
                      ▸
                    </span>
                    ソースを表示・編集
                  </summary>
                  ...
                  <details className="group">
                    ...
                    <div className="mt-3">
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        {renderContext?.chunk_count > 0 && (
                          <span className="text-xs text-[#0af] font-medium">
          ...
          {mode === 'manual' && prompt && (
            <div className="manual-output-card">
              ...
              <div className="manual-output-banner">
                ...
                <div className="flex-1">
                  <p className="text-[13px] font-semibold text-[#f0f0f5] tracking-tight">
                    指示文をクリップボードにコピー済み
                  </p>
                  <p className="text-[11px] text-[#6a6a7a] mt-0.5">
                    ChatGPT や Claude に貼り付けて実行してください
                  </p>
                </div>
                {renderContext?.chunk_count > 0 && (
                  <span className="text-[11px] font-medium text-[#0af] bg-[#0af]/[0.06] px-2.5 py-1 rounded-full flex-shrink-0">
              ...
              <div className="p-6 sm:p-8">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-lg font-bold text-[#f0f0f5] tracking-tight">AI の出力を貼り付け</h3>
                  <p className="text-[13px] text-[#6a6a7a] mt-1">
      ...
      <div ref={nextActionRef} className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 mt-8 sm:mt-10 mb-4 sm:mb-0 nav-glow-in">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
          ...
          {step === 2 && (
            <Button onClick={goNext} className="w-full sm:w-auto cta-glass cta-breathe !py-3.5 !text-base !rounded-2xl">
              次のステップへ →
            </Button>
          )}
          {step === 3 && mode === 'auto' && (
