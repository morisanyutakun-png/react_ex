...
function Badge({ children, color = 'slate' }) {
  const map = {
    indigo: 'bg-[#0071e3]/[0.08] text-[#0071e3] border-[#0071e3]/[0.12]',
...
function DetailBlock({ label, color = 'slate', children }) {
  const bgMap = { slate: 'bg-black/[0.04]', blue: 'bg-[#007aff]/[0.08]', indigo: 'bg-[#0071e3]/[0.08]', emerald: 'bg-[#34c759]/[0.08]' };
  return (
    <div>
          ...
          {hasActiveFilters && (
            <div className="flex items-center gap-2 pt-3 border-t border-black/[0.04]">
              ...
              <button onClick={clearFilters}
                className="text-[11px] text-[#aeaeb2] hover:text-[#0071e3] transition-all font-semibold
                           flex items-center gap-1 px-3 py-1.5 rounded-xl hover:bg-[#0071e3]/5 flex-shrink-0">
            ...
            return (
              <div key={item.id ?? idx}
                className={`result-item transition-all duration-300 
                  ${isOpen ? '!border-[#0071e3]/30 ring-1 ring-[#0071e3]/10 !bg-white shadow-lg' : ''}`}
                ...
                <div className="p-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <svg className={`w-4 h-4 text-[#c7c7cc] transition-transform duration-300 ${isOpen ? 'rotate-180 text-[#0071e3]' : ''}`}
      ...
      {!searching && !hasSearched && (
        <div className="text-center py-20">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-black/[0.04] mb-5 shadow-sm">
            <Icons.Search className="w-7 h-7 text-[#0071e3]" />
          </div>
