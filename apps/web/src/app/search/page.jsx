          ...
          {hasActiveFilters && (
            <div className="flex items-center gap-2 pt-3 border-t border-black/[0.04]">
              ...
              <button onClick={clearFilters}
                className="text-[11px] text-[#aeaeb2] hover:text-[#1d1d1f] transition-all font-semibold
                           flex items-center gap-1 px-3 py-1.5 rounded-xl hover:bg-[#1d1d1f]/5 flex-shrink-0">
            ...
            return (
              <div key={item.id ?? idx}
                className={`result-item transition-all duration-300 
                  ${isOpen ? '!border-[#1d1d1f]/30 ring-1 ring-[#1d1d1f]/10 !bg-white shadow-lg' : ''}`}
                ...
                <div className="p-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <svg className={`w-4 h-4 text-[#c7c7cc] transition-transform duration-300 ${isOpen ? 'rotate-180 text-[#1d1d1f]' : ''}`}
      ...
      {!searching && !hasSearched && (
        <div className="text-center py-20">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-black/[0.04] mb-5 shadow-sm">
            <Icons.Search className="w-7 h-7 text-[#1d1d1f]" />
          </div>
