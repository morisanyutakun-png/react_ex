...
// 工学系特化: 物理・数学・電気回路・応用情報のみ扱う
export const SUBJECTS = ['物理', '数学', '電気回路', '応用情報'];
...
export const SUBJECT_TOPICS = {
  ...
  '電気回路': [
    ...
    '半導体素子（ダイオード・トランジスタ）', 'オペアンプ',
    'ディジタル回路（論理ゲート・順序回路）',
  ],
  '応用情報': [
    'アルゴリズムとデータ構造', '計算量', 'ソート・探索',
    'オペレーティングシステム', 'データベース（SQL・正規化）',
    'ネットワーク（TCP/IP・OSI）', 'セキュリティ（暗号・認証）',
    'システム開発（要件・設計・テスト）',
    'プロジェクトマネジメント', 'システム戦略',
    'ハードウェア（CPU・メモリ）', 'ソフトウェア設計',
  ],
};
